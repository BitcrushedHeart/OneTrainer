...
class HunyuanVideoBaseDataLoader(
    ...
    def _preparation_modules(self, config: TrainConfig, model: HunyuanVideoModel):
        ...
        tokenize_prompt_1 = Tokenize(
            ...
            max_token_length=77,
            format_text=DEFAULT_PROMPT_TEMPLATE,
            additional_format_text_tokens=DEFAULT_PROMPT_TEMPLATE_CROP_START,
        )
        ...
        encode_prompt_1 = EncodeLlamaText(
            ...
            tokens_attention_mask_out_name="tokens_mask_1",
            text_encoder=model.text_encoder_1,
            hidden_state_output_index=-(1 + config.text_encoder_2_layer_skip),
            autocast_contexts=[model.autocast_context],
            dtype=model.train_dtype.torch_dtype(),
        ...
        encode_prompt_2 = EncodeClipText(
            ...
            hidden_state_out_name="text_encoder_2_hidden_states",
