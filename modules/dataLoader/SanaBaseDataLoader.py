...
class SanaBaseDataLoader(
    ...
    def _dpo_rejected_preparation_modules(self, config: TrainConfig, model: SanaModel) -> list:
        ...
        encode_image = EncodeVAE(
            ...
            out_name="latent_image_rejected",
            vae=model.vae,
    ...
    def _preparation_modules(self, config: TrainConfig, model: SanaModel):
        ...
        add_embeddings_to_prompt = MapData(
            in_name="prompt", out_name="prompt", map_fn=model.add_text_encoder_embeddings_to_prompt
        )
        ...
        encode_prompt = EncodeGemmaText(
            ...
            hidden_state_output_index=-(1 + config.text_encoder_layer_skip),
