...
class OptimizerParamsWindow(ctk.CTkToplevel):
    ...
    def create_dynamic_ui(
        ...
        KEY_DETAIL_MAP = {
            ...
            'k_warmup_steps': {'title': 'Kourkoutas Warmup Steps', 'tooltip': 'Number of steps over which the layer-wise dynamic β₂ adaptation (Kourkoutas Beta) ramps up from its initial value to the configured β₂. Leave empty to use the optimizer default. Only takes effect when Kourkoutas Beta is enabled.', 'type': 'int'},
