...
class BaseStableDiffusion3Setup(
    ...
    def setup_optimizations(
        ...
        if config.gradient_checkpointing.enabled():
            model.transformer_offload_conductor = enable_checkpointing_for_stable_diffusion_3_transformer(
    ...
    def predict(
        ...
        *,
        ...
        with model.autocast_context:
            ...
            text_encoder_output, pooled_text_encoder_output = model.combine_text_encoder_output(
                *model.encode_text(
                    ...
                    if "text_encoder_1_hidden_state" in batch and not config.train_text_encoder_or_embedding()
                    else None,
