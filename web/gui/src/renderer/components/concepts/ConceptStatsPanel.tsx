...
export function ConceptStatsPanel({ conceptPath, includeSubdirectories }: ConceptStatsPanelProps) {
    ...
    const processingTime =
        typeof s.processing_time === "number" ? `${(s.processing_time as number).toFixed(2)} s` : "-";
    ...
    const basicStats: StatValue[][] = [
        ...
        [
            ...
            },
            {
                ...
                tooltip:
                    "Total number of mask files which lack a corresponding image file — if > 0, check your dataset!",
            },
        ],
        [
            {
    ...
    const advancedStats: StatValue[][] = [
        ...
        [
            ...
            },
            {
                ...
                tooltip:
                    "Average length of caption in concept by character count. For token count, assume ~2 tokens/word",
            },
            {
                        ...
                        <>
                            ...
                            <div className="grid grid-cols-[1fr_auto] gap-4 items-start">
                                ...
                                <div className="flex flex-col gap-0.5 min-w-[160px]">
                                    ...
                                    />
                                    <span className="text-xs text-[var(--color-on-surface)] whitespace-pre-line">
                                        {smallestBuckets}
                                    </span>
                                </div>
                            </div>
