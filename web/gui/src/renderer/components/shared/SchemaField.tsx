...
export function SchemaField({ field, onAdvancedClick, resolveOptions, resolveKvOptions }: SchemaFieldProps) {
    ...
    switch (field.type) {
        ...
        case "select":
            return (
                <Select label={field.label} configPath={field.key} options={stringOptions} tooltip={field.tooltip} />
            );
        case "select-kv":
            return (
                <Select label={field.label} configPath={field.key} options={kvOptions ?? []} tooltip={field.tooltip} />
            );
        case "select-adv":
            return (
                <Select
