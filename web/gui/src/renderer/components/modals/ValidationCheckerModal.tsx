        ...
        <div className="grid grid-cols-[120px_1fr_120px_auto] gap-3 items-center px-3 py-2 border-b border-[var(--color-border-subtle)] text-sm">
            ...
            <div className="flex flex-col gap-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                    <span className="text-xs px-2 py-0.5 rounded-full bg-[var(--color-border-subtle)]">
                        {match.kind}
                    </span>
                    {match.score != null && (
                ...
                {!scanning && !summary && (
                    <div className="text-center py-8 text-[var(--color-on-surface-secondary)]">
                        ...
                        <p className="text-xs mt-1">
                            This compares your training and validation concepts for duplicates, near-duplicates, and
                            shared captions.
                        </p>
                    </div>
                )}
