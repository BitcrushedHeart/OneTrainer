    ...
    return (
      <div className="space-y-4">
        ...
        <p className="text-xs text-[var(--color-on-surface-secondary)]">
          Point to a folder of generated images with prompt metadata. Images are grouped by prompt, then you pick the
    ...
    return (
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="text-xs text-[var(--color-on-surface-secondary)]">
            Group {group.group_index} / {group.total_groups} &middot; AR: {group.aspectratio} &middot; ELO comparisons{" "}
            {eloDone}/{eloSuggested}
          </div>
          <div className="flex gap-1">
      ...
      <div className="space-y-3">
        ...
        >
          {phase === "best" ? (
            ...
            <>Best selected: {bestImage ? bestImage.split(/[/\\]/).pop() : ""}. Now click to select WORST (rejected)</>
          )}
        </div>
        ...
        {!checkResult && !reviewPairs && !loading && !error && (
          <div className="text-center py-8 text-[var(--color-on-surface-secondary)]">
            ...
            <p className="text-xs mt-1">
              Use <strong>Selection Mode</strong> to score generated images and create pairs, or use the other tools to
