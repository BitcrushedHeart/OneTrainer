        ...
        <ModalBase open={open} onClose={onClose} title={`Sample ${sampleIndex + 1} Parameters`} size="xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                ...
                <FormEntry
                    ...
                    configPath={`${p}.frames`}
                    type="number"
                    tooltip="Frame count for video models"
                />
                <FormEntry
                ...
                <FormEntry
                    label="TE1 Seq Length"
                    configPath={`${p}.text_encoder_1_sequence_length`}
                    type="number"
                    nullable
                />
                <FormEntry label="TE2 Layer Skip" configPath={`${p}.text_encoder_2_layer_skip`} type="number" />
                <FormEntry
                    label="TE2 Seq Length"
                    configPath={`${p}.text_encoder_2_sequence_length`}
                    type="number"
                    nullable
                />
            ...
            <div className="grid grid-cols-1 gap-4 mt-4">
                <FilePicker
                    label="Base Image"
                    configPath={`${p}.base_image_path`}
                    tooltip="Base image for inpainting"
                />
                <FilePicker
                    label="Mask Image"
                    configPath={`${p}.mask_image_path`}
                    tooltip="Mask image for inpainting"
                />
            </div>
