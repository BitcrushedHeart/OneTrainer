    ...
    return (
        <ModalBase open={open} onClose={onClose} title="Muon + Adam Settings" size="md">
            <div className="flex flex-col gap-4">
                ...
                <Toggle
                    configPath="optimizer.normuon_variant"
                    label="Normuon Variant"
                    tooltip="Use the Normuon variant"
                />
                <FormEntry
                    label="Beta2 Normuon"
                ...
                <Toggle
                    configPath="optimizer.low_rank_ortho"
                    label="Low Rank Ortho"
                    tooltip="Use low-rank orthogonalization"
                />
                <FormEntry
                    label="Ortho Rank"
