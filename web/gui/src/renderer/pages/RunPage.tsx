                    ...
                    {isActive && progress && (
                        <>
                            <div className="flex-1 min-w-[120px]">
                                <ProgressBar
                                    value={progress.maxStep > 0 ? (progress.step / progress.maxStep) * 100 : 0}
                                />
                            </div>
            ...
            {!loading && noRunsExist && !fetchError && (
                <div className="card card-static p-8 text-center">
                    ...
                    <p className="m-0 mx-auto text-[var(--color-on-surface-secondary)] text-small leading-relaxed max-w-[420px]">
                        TensorBoard event files will appear here once you start a training run. The log directory is
                        derived from your workspace configuration.
                    </p>
                </div>
            )}
