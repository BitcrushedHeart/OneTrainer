...
export default function SamplingPage() {
  ...
  const list: SampleConfig[] = samples ?? [];
    ...
    <div className="flex flex-col gap-6">
      <SectionCard title="Sampling Settings">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          />
          <Select
            label="Sample After Unit"
            configPath="sample_after_unit"
            options={[...TimeUnitValues]}
          />
          <FormEntry
            label="Skip First"
          ...
          <Select
            label="Image Format"
            configPath="sample_image_format"
            options={[
              { label: "PNG", value: "PNG" },
              { label: "JPG", value: "JPG" },
            ]}
